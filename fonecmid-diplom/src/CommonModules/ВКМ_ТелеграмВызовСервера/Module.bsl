...
Процедура ОтправитьНакопленныеУведомления() Экспорт
    ...
    Пока Выборка.Следующий() Цикл
        ...
        Попытка
            УспешноОтправлено = ОтправитьСообщение(
                УведомлениеОбъект.ВКМ_ТекстСообщения);
        Исключение
            ЗаписьЖурналаРегистрации(
                "ВКМ_Телеграм",
                УровеньЖурналаРегистрации.Ошибка,
                ,
                "Ошибка отправки уведомления: " + ОписаниеОшибки());
        КонецПопытки;
...
Функция ОтправитьСообщение(ТекстСообщения) Экспорт
    ...
    Соединение = Новый HTTPСоединение("api.telegram.org", 443, , , , 30, ЗащищенноеСоединение);
